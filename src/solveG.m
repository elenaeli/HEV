% This function is separate from the Matlab embedded one and is intended to
% compute the solution and to plot the payoffs of all solution approaches
function [engineTorque,motorTorque] = solveG(payoffEngine, payoffMotor, ...
    ...
    %    motorTorque = 0;
        ...
        [paretoStrategies, paretoIndex, x, y] = paretoefficiency(payoffEngine, payoffMotor);
        ...
        p7 = plot(ks(1,1), ks(1,2), 'o', 'MarkerFaceColor', purple, ...
           'MarkerEdgeColor', purple, 'MarkerSize', 14);
        ...
        p8 = plot(payoffBoth(imput(indCore),1), payoffBoth(imput(indCore),2), 'o', ...
           ...
           'MarkerSize', 9);      
        red = [1 0 0];
        p9 = plot(shEngine, shMotor, 'o', 'MarkerFaceColor', red, ...
        ...
        leg = legend([p1 p2 p3 p4 p6 p7 p8 p9], 'Payoff', ...   
            'Pareto Efficiency',...  
            'Pareto Optimality' , ...
            'Nash Equilibrium', ...   
            'Nash Solution', ...     
...
%             'Nash Equilibrium NPG', ...       
            ...
            xlabel('Payoff Engine','FontSize',13);
            ylabel('Payoff Motor','FontSize',13);            
