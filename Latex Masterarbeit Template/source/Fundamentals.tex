...
With the Shapley value, which was the final game-theoretical solution concept, the Fundamentals chapter is closed. To conclude, the chapter described the principles of hybrid vehicles and defined the game to be played formally. In addition, it described the theoretical principles of six game theory solution approaches applicable to cooperative games with two players.