...
nzpvluxqo1 ; real_T gj0z5teswu ; real_T dks5t0rchn ; real_T boxfyroykz ;
real_T gfnebsmhwv ; real_T ludevrgvrx ; real_T htsyt1c0no ; real_T llfprdkco5
; real_T puuqlcshxw ; boolean_T cq224qj4y1 ; int32_T rowIdx ; real_T * lastU
...
llfprdkco5 ; } HEV_acc_Look2D_real_T_real_T_real_T ( & ( _rtB -> lvjrio3qws )
...
fez00ly5gv = _rtB -> pdsnyrwzxm / llfprdkco5 ; ssCallAccelRunBlock ( S , 16 ,
206 , SS_CALL_MDL_OUTPUTS ) ; _rtB -> oompwwasmy = _rtX -> iglmayn3zq ; _rtB
-> boctzwx3r2 = llfprdkco5 * ld5zvvrfqt ( S ) -> a35rxrg3n1 ; _rtB ->
fez00ly5gv *= _rtB -> boctzwx3r2 ; llfprdkco5 = _rtB -> oompwwasmy / _rtB ->
fez00ly5gv ; if ( llfprdkco5 <= 0.0 ) { _rtB -> npqw2hqsht = 0.0 ; } else {
_rtB -> npqw2hqsht = llfprdkco5 ; } ssCallAccelRunBlock ( S , 16 , 213 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 16 , 214 ,
SS_CALL_MDL_OUTPUTS ) ; _rtB -> pkn3qaidb3 = _rtX -> p24x5vnk3x ; llfprdkco5
= _rtB -> pkn3qaidb3 / _rtB -> fez00ly5gv ; if ( llfprdkco5 <= 0.0 ) { _rtB
-> npqw2hqsht = 0.0 ; } else { _rtB -> npqw2hqsht = llfprdkco5 ; }
ssCallAccelRunBlock ( S , 16 , 218 , SS_CALL_MDL_OUTPUTS ) ; _rtB ->
dju111pk51 = _rtX -> jntxheunx4 ; llfprdkco5 = _rtB -> dju111pk51 / _rtB ->
fez00ly5gv ; if ( llfprdkco5 <= 0.0 ) { _rtB -> npqw2hqsht = 0.0 ; } else {
_rtB -> npqw2hqsht = llfprdkco5 ; } ssCallAccelRunBlock ( S , 16 , 222 ,
...
SS_CALL_MDL_OUTPUTS ) ; _rtB -> ipal3laumf = 0.001 * _rtB -> lvjrio3qws ;
...
i1yji2rzyc = _rtB -> npqw2hqsht - _rtB -> ozl5w3wauj ; iiis24gb3o = 0.02 *
...
else { llfprdkco5 = byehzqrbel ; } puuqlcshxw = ssGetT ( S ) ; _rtB ->
kgzzaktogw = ( real_T ) ( puuqlcshxw > ld5zvvrfqt ( S ) -> ezi3fip04t ) *
llfprdkco5 ; puuqlcshxw = _rtB -> kgzzaktogw * _rtB -> kkpq2kwxuh ; if (
...
; } } } j0jhyqa1p3 = puuqlcshxw - _rtB -> hijbmmvub5 ; llfprdkco5 =
...
) ; if ( llfprdkco5 > 5000.0 ) { _rtB -> npqw2hqsht = 5000.0 ; } else if (
llfprdkco5 < 750.0 ) { _rtB -> npqw2hqsht = 750.0 ; } else { _rtB ->
npqw2hqsht = llfprdkco5 ; } byehzqrbel = 0.10471975511965977 * _rtB ->
...
c3cdumk5ue || ( ( puuqlcshxw > ld5zvvrfqt ( S ) -> fvqe355sya ) && _rtB ->
...
_rtB -> ffx4mzj1i4 ; } puuqlcshxw = 1.0 / byehzqrbel * _rtB -> m2y1khvsri [
...
_rtB -> pqvfeo32cg = iiis24gb3o ; } puuqlcshxw = - _rtB -> pqvfeo32cg *
...
_rtB -> e2knxf1dm4 = puuqlcshxw ; } if ( ssIsSampleHit ( S , 2 , 0 ) ) { if (
...
} } } puuqlcshxw = muDoubleScalarAbs ( _rtB -> dil4xbueyo ) ; _rtB ->
c2ivurwyme = rt_Lookup ( ni220kbneq . hvtx2huqpc , 301 , puuqlcshxw ,
...
drqvxpnrgk - _rtB -> kvbxxzddjn ) * 200.0 ; } puuqlcshxw = _rtB -> oxn35udia2
; if ( puuqlcshxw > 21000.0 ) { _rtB -> dybzfcfnxv = 21000.0 ; } else if (
puuqlcshxw < 0.0 ) { _rtB -> dybzfcfnxv = 0.0 ; } else { _rtB -> dybzfcfnxv =
...
) { _rtB -> jybu53irkl = _rtDW -> bv5gvrfela ; } _rtB -> fez00ly5gv = _rtB ->
...
0.77682632969980325 ) - 85.397025568738272 * _rtB -> d4jqz2ve5w ; puuqlcshxw
= muDoubleScalarAbs ( _rtB -> kkpq2kwxuh ) ; HEV_acc_LookUp_real_T_real_T ( &
( dks5t0rchn ) , ni220kbneq . pormlyvumi , puuqlcshxw , ni220kbneq .
johzj1udqh , 6U ) ; if ( _rtB -> eyavresob4 > dks5t0rchn ) { puuqlcshxw =
dks5t0rchn ; } else if ( _rtB -> eyavresob4 < - dks5t0rchn ) { puuqlcshxw = -
dks5t0rchn ; } else { puuqlcshxw = _rtB -> eyavresob4 ; } puuqlcshxw *=
...
_rtB -> hcgjikrwsl = puuqlcshxw ; } if ( ssIsSampleHit ( S , 3 , 0 ) ) { _rtB
...
psae1mjui2 ; } _rtB -> fez00ly5gv = _rtB -> netq4xlqvp * _rtB -> m2y1khvsri [
...
) -> f4itz54uxy ; } _rtB -> irchshx0ry = ( real_T ) ( puuqlcshxw > ld5zvvrfqt
...
1.0 ; } } } puuqlcshxw = 0.001 * _rtB -> irchshx0ry + _rtB -> krg1d2xh0a ; if
...
) -> nzabkt43tm ; if ( puuqlcshxw > 1.0 ) { _rtB -> boctzwx3r2 = 1.0 ; } else
if ( puuqlcshxw < 0.0 ) { _rtB -> boctzwx3r2 = 0.0 ; } else { _rtB ->
boctzwx3r2 = puuqlcshxw ; } ssCallAccelRunBlock ( S , 16 , 888 ,
...
p44y0w4hfk , ni220kbneq . bvhb4ijxid , 108U ) ; if ( _rtB -> o0mdtsxsuo <=
...
bvhb4ijxid [ iLeftU0 ] ) ; num = _rtB -> p44y0w4hfk ; num -= ( ni220kbneq .
...
; { uint32_T iLeftU0 , iRghtU0 , iLeftU1 , iRghtU1 ;
HEV_acc_BINARYSEARCH_real_T ( & ( iLeftU0 ) , & ( iRghtU0 ) , _rtB ->
ptlppe1ifn , ni220kbneq . bvhb4ijxid , 108U ) ; if ( _rtB -> pw2tl3utlu <=
...
iRghtU0 ] ) > ( ni220kbneq . bvhb4ijxid [ iLeftU0 ] ) ) { real_T num ; real_T
den ; den = ( ni220kbneq . bvhb4ijxid [ iRghtU0 ] ) ; den -= ( ni220kbneq .
bvhb4ijxid [ iLeftU0 ] ) ; num = _rtB -> ptlppe1ifn ; num -= ( ni220kbneq .
bvhb4ijxid [ iLeftU0 ] ) ; u0Lambda = num / den ; } else { u0Lambda = 0.0 ; }
...
; { uint32_T iLeftU0 , iRghtU0 , iLeftU1 , iRghtU1 ;
HEV_acc_BINARYSEARCH_real_T ( & ( iLeftU0 ) , & ( iRghtU0 ) , _rtB ->
dalnffdjau , ni220kbneq . bvhb4ijxid , 108U ) ; if ( _rtB -> nzwvbjtqss <=
...
iRghtU0 ] ) > ( ni220kbneq . bvhb4ijxid [ iLeftU0 ] ) ) { real_T num ; real_T
den ; den = ( ni220kbneq . bvhb4ijxid [ iRghtU0 ] ) ; den -= ( ni220kbneq .
bvhb4ijxid [ iLeftU0 ] ) ; num = _rtB -> dalnffdjau ; num -= ( ni220kbneq .
bvhb4ijxid [ iLeftU0 ] ) ; u0Lambda = num / den ; } else { u0Lambda = 0.0 ; }
{ real_T yLeftCast ; real_T yRghtCast ; yLeftCast = ( ni220kbneq . aeijn3z5nk
[ ( iLeftU0 + 109U * iLeftU1 ) ] ) ; yRghtCast = ( ni220kbneq . aeijn3z5nk [
( iLeftU0 + 109U * iRghtU1 ) ] ) ; yLeftCast += u1Lambda * ( yRghtCast -
...
; { uint32_T iLeftU0 , iRghtU0 , iLeftU1 , iRghtU1 ;
HEV_acc_BINARYSEARCH_real_T ( & ( iLeftU0 ) , & ( iRghtU0 ) , _rtB ->
pfrgh32csb , ni220kbneq . bvhb4ijxid , 108U ) ; if ( _rtB -> hx2xopo0cd <=
...
iRghtU0 ] ) > ( ni220kbneq . bvhb4ijxid [ iLeftU0 ] ) ) { real_T num ; real_T
den ; den = ( ni220kbneq . bvhb4ijxid [ iRghtU0 ] ) ; den -= ( ni220kbneq .
bvhb4ijxid [ iLeftU0 ] ) ; num = _rtB -> pfrgh32csb ; num -= ( ni220kbneq .
bvhb4ijxid [ iLeftU0 ] ) ; u0Lambda = num / den ; } else { u0Lambda = 0.0 ; }
{ real_T yLeftCast ; real_T yRghtCast ; yLeftCast = ( ni220kbneq . osuhnhw40g
[ ( iLeftU0 + 109U * iLeftU1 ) ] ) ; yRghtCast = ( ni220kbneq . osuhnhw40g [
( iLeftU0 + 109U * iRghtU1 ) ] ) ; yLeftCast += u1Lambda * ( yRghtCast -
...
_rtB -> npqw2hqsht = _rtB -> m2y1khvsri [ 9 ] * _rtB -> htjriwobeu [ 2 ] ;
_rtB -> boctzwx3r2 = _rtB -> htjriwobeu [ 3 ] * _rtB -> m2y1khvsri [ 6 ] ;
_rtB -> fez00ly5gv = _rtB -> m2y1khvsri [ 8 ] * _rtB -> htjriwobeu [ 11 ] ;
...
_rtB -> h4hdvz1ojz ; _rtDW -> jnhtlxaxxk = _rtB -> acoi1pgdho ; } if (
...
{ ssSetChecksumVal ( S , 0 , 1103869108U ) ; ssSetChecksumVal ( S , 1 ,
3956332758U ) ; ssSetChecksumVal ( S , 2 , 726038260U ) ; ssSetChecksumVal (
S , 3 , 1892401333U ) ; { mxArray * slVerStructMat = NULL ; mxArray *
