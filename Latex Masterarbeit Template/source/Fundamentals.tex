...
\end{equation}
\begin{equation}
\sum_{i=1}^{n} \sum_{j=m+1}^{m+n} b_{ij}s_i^*t_j^* = \max_{t \in T} \sum_{i=1}^{n} \sum_{j=m+1}^{m+n} b_{ij}s_i^* t_j
\end{equation}


If we also define the sets:
\begin{equation}
\tilde{S} =  S \cup \{ s \geq 0: \sum_{i=1}^{n} s_i \leq 1 \text{ and } \prod_{i=1}^{m} s_i = 0 \}
\end{equation}

\begin{equation}
\tilde{T} = T \cup \{t \geq 0: \sum_{j=m}^{m+n} t_i \leq 1 \text{ and } \prod_{j=n}^{m+n} t_i = 0 \}
\end{equation}
...
\begin{equation}
S^j = \{ s \in S: \sum_{i=1}^{m} b_{ij} s_i = \max_{l \in \{m+1,...,m+n\}} \sum_{i=1}^{m} b_{il} s_i \} \text{ for } j \in \{m+1,m+2,...,m+n\}
\end{equation}
...
\begin{equation} 
T^i = \{ t \in T: \sum_{j=m+1}^{m+n} a_{ij} t_j = \max_{l \in \{1,...,m\}} \sum_{j=m+1}^{m+n} a_{lj} t_j \} \text{ for } i \in \{1,...,m\} 
\end{equation}
