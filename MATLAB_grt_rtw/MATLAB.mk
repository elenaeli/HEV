###########################################################################
## Makefile generated for Simulink model 'MATLAB'. 
## 
## Makefile     : MATLAB.mk
## Generated on : Wed Mar 02 10:43:02 2016
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MATLAB.exe
...
MAKEFILE                  = MATLAB.mk
COMPUTER                  = PCWIN
MATLAB_ROOT               = C:/PROGRA~2/MATLAB/R2015a
MATLAB_BIN                = C:/PROGRA~2/MATLAB/R2015a/bin
MATLAB_ARCH_BIN           = C:/PROGRA~2/MATLAB/R2015a/bin/win32
MASTER_ANCHOR_DIR         = 
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = MATLAB_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = MATLAB_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MATLAB.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/MATLAB_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=MATLAB -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/MATLAB_grt_rtw/MATLAB.c $(START_DIR)/MATLAB_grt_rtw/rtGetInf.c $(START_DIR)/MATLAB_grt_rtw/rtGetNaN.c $(START_DIR)/MATLAB_grt_rtw/rt_nonfinite.c rt_logging.c $(MATLAB_ROOT)/rtw/c/src/common/rt_main.c
...
OBJS = MATLAB.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/MATLAB_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
